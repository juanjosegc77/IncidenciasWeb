...
<html>
    ...
    <body>
        <form name="form_vacaciones" class="needs-validation border border-secundary" novalidate action="ControladorVacaciones?menu=Vacaciones" method="POST">
            <div class="form-group">
                <div class="d-flex justify-content-around align-items-start" style="margin-top: 20px; margin-left: 20px; margin-right: 20px;">
                    ...
                    <label for="adsc" class="text-primary" style="margin-right: 20px;">ADSC</label>
                    <div class="col-md-1">
                    ...
                    <div class="input-group col-mb-3">
                        ...
                        <div class="input-group-append">
                            <a id="button_buscar" class="btn btn-primary" rol="button" href="javascript: validate();">Buscar</a>
                        </div>
                    </div>
            ...
            <div class="form-row" style="margin-top: 30px; margin-left: 20px; margin-right: 20px; margin-bottom: 20px">
                <div>
                ...
                <div class="col-sm-2">
                    ...
                    <div class="input-group col-mb-2">
                        <input name="date_inicio" type="date" pattern = "dd-mm-yyyy" class="form-control" id="inicio" required value="${vacaciones_editar.getInicio()}">
                        <div class="input-group-append">
                            <a id="button_reanudacion" class="btn btn-primary" rol="button" href="javascript: calcularFechaReanudacion();">R</a>
                        </div>
                    </div>
                    <div class="invalid-feedback">
                        Campo obligatorio.
        ...
        <div class="table-responsive" style="max-height:480px; margin-top: 20px;">
            <table id="vacaciones" class="table table-striped" style="width:100%;">
                ...
                <tbody class="context-menu-one"> 
                    <c:forEach var="vacaciones" items="${list_vacaciones}">
                        <tr>
                            <td>
                                <a class="btn btn-warning" href="ControladorVacaciones?menu=Vacaciones&accion=cargar_datos_actualizar&id_vacaciones=${vacaciones.getId_vacaciones()}">Editar</a>
                                <a class="btn btn-danger" href="ControladorVacaciones?menu=Vacaciones&accion=borrar&id_vacaciones=${vacaciones.getId_vacaciones()}">Borrar</a>
                            </td>
