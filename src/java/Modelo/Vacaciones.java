...
public class Vacaciones {
    ...
    public Vacaciones(int id_vacaciones, int id_empleado, int folio, int clave, String periodo, int num_dias, String inicio, String dias, String notas, String fecha_captura, String historial_cambios) {
